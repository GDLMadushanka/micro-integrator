...
//    protected void setClusteringAgent(CarbonServerConfigurationService configurationContextService) {
//        dataHolder.setClusteringAgent(configurationContextService.getServerConfigContext().getAxisConfiguration().
//                getClusteringAgent());
//    }

    protected void unsetClusteringAgent(CarbonServerConfigurationService configurationContextService) {
